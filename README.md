...
| Cameras | 17 + 1 | [Ontario 511](https://511on.ca/) (Ministry of Transportation public API), plus independent YouTube live streams | 17 highway cameras covering the Northwestern Ontario corridor (Hwy 11/17/61/527/595, roughly Ignace to Nipigon), not just the city — that's the actual coverage area of this data. Each popup embeds a live snapshot image (reloads on open, not a static photo). Plus a small, hand-curated set of independent YouTube live streams — currently one: the City's own landfill entrance cam at 5405 Mapleward Rd, embedded as a live player rather than a snapshot. Other "Thunder Bay webcam" sources found while researching the 511 cameras were dead (an old personal page, a CBC link) or the wrong Thunder Bay entirely (a NOAA webcam, and a "Thunder Bay" YouTube search result, both actually in Alpena, Michigan). |
